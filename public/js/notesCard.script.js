...
allReviewsLink = document.getElementById("filter-link");
myReviews = document.getElementById("rating-view-user");
allReviews = document.getElementById("rating-view-all");
backToMyReviews = document.getElementById("back-to-my-reviews");
